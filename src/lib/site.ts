...
export const primaryNav = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Individual & Group Therapies", href: "/services/individual-group-therapies" },
      { label: "Family Therapy", href: "/services/family-therapy" },
      { label: "Judicial Services", href: "/services/judicial-services" },
      { label: "Primary Care", href: "/services/primary-care" },
      { label: "Case Management", href: "/services/case-management" },
      { label: "Sober Living Home", href: "/services/sober-living-home" },
      ...
      { label: "Intensive Outpatient", href: "/services/intensive-outpatient" },
    ],
  },
  { label: "Insurance", href: "/insurance" },
  {
    ...
    children: [
      ...
      { label: "Community Resources", href: "/resources/community-resources" },
