...
import { confirmPatientMfa, type MfaState } from "@/app/patient-portal/security/actions";

export function PatientMfaSetup({ qrDataUrl, secret }: { qrDataUrl: string; secret: string }) {
  const [state, action, pending] = useActionState<MfaState, FormData>(confirmPatientMfa, {});
